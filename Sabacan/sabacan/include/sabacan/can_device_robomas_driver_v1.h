...
public:
  ...
  void setGearRatio(int n, float _val)
  {
    tx(((n & 0xF) << 8) | RobomasV1::CONTROL_TYPE, _val);
  }

  void setCanTimeout(uint16_t _val)
  {
    tx(RobomasV1::CAN_TIMEOUT, _val);
  }

  void setPwmTarget(int n, float _target)
  {
    tx(((n & 0xF) << 8) | RobomasV1::PWM_TARGET, _target);
  }
  ...
  void setPwmLim(int n, float _val)
  {
    tx(((n & 0xF) << 8) | RobomasV1::PWM_LIM, _val);
  }

  void setSpeedGainP(int n, float _val)
  {
    tx(((n & 0xF) << 8) | RobomasV1::SPEED_PID_P, _val);
  }

  void setSpeedGainI(int n, float _val)
  {
    tx(((n & 0xF) << 8) | RobomasV1::SPEED_PID_I, _val);
  }

  void setSpeedGainD(int n, float _val)
  {
    tx(((n & 0xF) << 8) | RobomasV1::SPEED_PID_D, _val);
  }
  ...
  void setSpeedLim(int n, float _val)
  {
    tx(((n & 0xF) << 8) | RobomasV1::SPEED_LIM, _val);
  }

  void setPosGainP(int n, float _val)
  {
    tx(((n & 0xF) << 8) | RobomasV1::POSITION_PID_P, _val);
  }

  void setPosGainI(int n, float _val)
  {
    tx(((n & 0xF) << 8) | RobomasV1::POSITION_PID_I, _val);
  }

  void setPosGainD(int n, float _val)
  {
    tx(((n & 0xF) << 8) | RobomasV1::POSITION_PID_D, _val);
  }
  ...
  void setAbsTurnCnt(int n, int32_t _val)
  {
    tx(((n & 0xF) << 8) | RobomasV1::ABS_TURN_CNT, _val);
  }
