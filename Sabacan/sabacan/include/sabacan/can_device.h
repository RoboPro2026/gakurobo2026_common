...
public:
  ...
  void register_tx_callback(TxCallback callback)
  {
...
protected:
  ...
  {
    CanFrame frame{.is_request = true,
                   .priority = 0,
                   .data_type = data_type,
                   .board_id = board_id,
  ...
  template <typename T> void tx(uint16_t register_id, T data)
  {
    CanFrame frame{.is_request = false,
                   .priority = 0,
                   .data_type = data_type,
                   .board_id = board_id,
                   .register_id = register_id,
  ...
  template <typename T> void assign(T* data, uint8_t* receive_data)
  {
