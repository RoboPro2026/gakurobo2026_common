...
{
public:
  SabaneCanNode() : Node("sabacan_robomasv2_node")
  {
    // パラメータの宣言
...
private:
  ...
  {
    // トルク制御
    // robomas_driver_->setControl(0, RobomasV2::CONTROL_MODE_TRQ, RobomasV2::CONTROL_MOTOR_M2006,
    // 0, 0, 0);
    // robomas_driver_->setSpeedTarget(0, 3.14);

    // 速度制御+dob
    // robomas_driver_->setControl(0, RobomasV2::CONTROL_MODE_SPD, RobomasV2::CONTROL_MOTOR_M2006,
    // 1,
    //                             0, 0);
    // robomas_driver_->setSpeedTarget(0, 3.14);

    // 位置制御+dob
    // robomas_driver_->setControl(0, RobomasV2::CONTROL_MODE_POS, RobomasV2::CONTROL_MOTOR_M2006,
    // 1,
    //                             0, 0);
    // robomas_driver_->setSpeedTarget(0, 3.14);
    // vescモード
    // robomas_driver_->setVescMode(0, RobomasV2::VESC_MODE_SPEED);
    // robomas_driver_->setVescTarget(0, 20);

    // robomas_driver_->setVescMode(0, RobomasV2::VESC_MODE_PWM);
    // robomas_driver_->setVescTarget(0, 0.3);
  }
